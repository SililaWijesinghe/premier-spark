      ...
      <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="prose prose-invert max-w-none prose-p:text-[#A5B0C3] prose-headings:text-[#F8FAFC] prose-li:text-[#A5B0C3]">
            ...
            <p>Welcome to Premier Digital. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.</p>
            ...
            <h2 className="text-2xl mt-8 mb-4">5. Your Legal Rights</h2>
